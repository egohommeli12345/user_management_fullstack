...
function Login() {
  ...
  return (
    <div>
      {showResetPassword && <ResetPassword onResetPassword={handleResetPasswordClick} />}
      {showRegisterUser && <RegisterUser onRegister={handleRegisterUserClick} />}
...
function MainScreen({ onResetPassword, onRegister }: ResetPwProps & RegisterProps) {
      ...
      <form onSubmit={handleCheckLogin}>
        <div className="inputs">
          ...
          <div className="registerreset">
            <button className="resetpwLogin" onClick={onResetPassword}>
              Reset password
            </button>
            <button className="registerLogin" type="button" onClick={onRegister}>
              Register
            </button>
          </div>
        </div>
  ...
  return (
    <div className="loginbg">
      ...
      <div className="inputs">
        ...
        <button className="registerAction" type="button" onClick={onRegister}>
          Register
        </button>
      </div>
    </div>
